...
LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//authors.csv' 
...
LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//maintrack_papers.csv'
INTO TABLE MainTrackPapers FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'
IGNORE 1 ROWS (PaperID, Title);

LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//workshops.csv' 
INTO TABLE Workshops FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
IGNORE 1 ROWS (WorkshopID, WName);

LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//wkshp_papers.csv' 
INTO TABLE WorkshopPapers FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
IGNORE 1 ROWS (WPaperID, Title, WorkshopID);

LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//organizers.csv' 
...
LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//workshop_organizers.csv' 
...
LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//volunteers.csv' 
...
LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//awards.csv' 
...
LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//external_attendees.csv' 
...
LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//tutorials.csv' 
INTO TABLE Tutorials FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
IGNORE 1 ROWS (TutorialID, Topic, TutDate, Timing);

LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//tutors.csv'
...
LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//maintrack_authors.csv' 
INTO TABLE MainTrackAuthors FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
IGNORE 1 ROWS (AuthorID, PaperID);

LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//wkshp_paper_authors.csv' 
INTO TABLE WkshpPaperAuthors FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
IGNORE 1 ROWS (AuthorID, WPaperID);

LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//volunteers_to_organizers.csv' 
INTO TABLE VolunteerReportsToOrganizers FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
IGNORE 1 ROWS (VolunteerID, OrganizerID);

LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//authors_attends_tut.csv' 
INTO TABLE AuthorAttendsTutorial FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
IGNORE 1 ROWS (TutorialID, AuthorID, Present);

LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//wo_to_wkshp.csv' 
INTO TABLE WorkOrgOrganizesWorkshop FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
IGNORE 1 ROWS (WOID, WorkshopID);

LOAD DATA LOCAL INFILE 'C://Users//Dell//Desktop//DBMS-project//data//attendees_to_tuts.csv' 
INTO TABLE AttendeeAttendsTutorial FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
IGNORE 1 ROWS (TutorialID, AttendeeID, Present);

select * from AttendeeAttendsTutorial;
select * from AuthorAttendsTutorial;
select * from MainTrackPapers;
select * from MainTrackAuthors;
select * from Authors;
select * from Awards;
select * from WkshpPaperAuthors;
select * from WorkshopPapers;
select * from Tutors;
select * from Tutorials;
select * from Workshops;
select * from WorkshopOrganizers;
select * from Organizers;
select * from Volunteers;
select * from VolunteerReportsToOrganizers;
select * from WorkOrgOrganizesWorkshop;
select * from ExternalAttendees;
select * from AttendeeAttendsTutorial;
